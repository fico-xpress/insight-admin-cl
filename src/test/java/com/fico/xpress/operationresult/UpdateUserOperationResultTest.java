/*
    ...
    ============================
    UpdateUserOperationResultTest.java
    ```````````````````````
...
public class UpdateUserOperationResultTest {

    @InjectMocks
    private UpdateUserOperationResult updateUserOperationResult;
    @Test
    public void testPrint(){
        ...
        updateUserOperationResult.setUserInfoExtended(userInfoExtended);
        updateUserOperationResult.print(out);
