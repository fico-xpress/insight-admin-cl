/*
    ...
    ============================
    AddAuthorityGroupOperationResultTest.java
    ```````````````````````
...
public class AddAuthorityGroupOperationResultTest {

    @InjectMocks
    private AddAuthorityGroupOperationResult addAuthorityGroupOperationResult;
    ...
    public void testPrint(){
        ...
        authorityGroupExtended.setName("name");
        addAuthorityGroupOperationResult.setAuthorityGroupExtended(authorityGroupExtended);
        addAuthorityGroupOperationResult.print(out);
