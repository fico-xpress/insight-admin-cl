...
public class AddUserOperationResult implements OperationResult {

    private UserInfoExtended userInfoExtended;

    public AddUserOperationResult(UserInfoExtended userInfoExtended){
        this.userInfoExtended = userInfoExtended;
    }

    /**
     * Prints that User added successfully
     * @param out
     */
    @Override
    public void print(PrintStream out) {
        out.println(userInfoExtended.getUsername() + " Successfully added.");
    }

    /**
     * Method to set userInfoExtended object.
    ...
    /**
     * Method to get userInfoExtended object.
     * @return
     */
